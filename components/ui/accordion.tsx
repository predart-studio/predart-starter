...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <CaretDown weight="bold" data-slot="accordion-trigger-icon" className="pointer-events-none shrink-0 size-4 group-aria-expanded/accordion-trigger:hidden" />
        <CaretUp weight="bold" data-slot="accordion-trigger-icon" className="pointer-events-none hidden shrink-0 size-4 group-aria-expanded/accordion-trigger:inline" />
      </AccordionPrimitive.Trigger>
