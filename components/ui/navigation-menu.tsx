...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <CaretDown weight="bold" className="relative top-px ml-1 size-3 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180" aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  )
}
